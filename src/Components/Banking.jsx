...
export default function Banking() {
  return (
    <div className='w-full flex flex-col md:flex-row font-title justify-around z-20 ml-5 mt-16'>
      ...
      <div className='w-full md:w-2/3 bg-white mx-0 md:mx-10 flex flex-col justify-around rounded-xl mt-8 md:mt-0'>
        ...
        <div className='relative flex flex-col justify-around'>
          <div className='pl-4 md:pl-12'>
            <h1 className='pt-4 text-2xl md:text-3xl font-semibold'>Access your card at any time</h1>
            <p className='pt-2 text-xl font-thin'>Every Nova checking account comes with a free physical debit card</p>
            <p className='pt-2 text-xl font-thin'>and virtual debit card, so you always have access at your</p>
            <p className='pt-2 text-xl font-thin'>fingertips.</p>
          </div>
        ...
        <div className='pl-4 md:pl-12'>
          <h1 className='text-xl md:text-2xl'>Make money work for you</h1>
        ...
        <div className='pl-4 md:pl-12'>
          <h1 className='text-xl md:text-2xl'>Pay and get paid your way</h1>
          <MoveDownRight className='hidden md:block ml-auto' />
        </div>
      </div>
    </div>
